...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        for track in self.track_list:
            ...
            if ((track.state == 'tentative' or track.state == 'initialized') and (track.P[0,0] > params.max_P or track.P[1,1] > params.max_P or track.P[2,2] > params.max_P)):
                    self.delete_track(track)
    ...
    def handle_updated_track(self, track):      
        ...
        if track.score < 1:
            track.score += (1.0 / params.window)
        if (1.0 / params.window) < track.score < params.confirmed_threshold:
